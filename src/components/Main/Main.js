    ...
    return (
        <div className='main'>
            <div className='navigation'>
                ...
                <div
                    className={circleTop === 72 || (page === "intro" && circleTop === undefined)
                        ? 'red-square'
                        : 'red-circle'
                    }
                ...
                <div className='menu-list' onMouseLeave={() => setCircleTop(defaultCircleTop)}>
                    <div
